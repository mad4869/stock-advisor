  ...
  return (
    <div className="card space-y-4">
      ...
      <div className="flex gap-3">
        <div className="bg-dark-800 rounded-xl px-4 py-2 border border-dark-600 flex-1 flex flex-col justify-between">
          <div>
          ...
          <p className="text-[8px] text-gray-500 mt-1">
            Strong: ≥15% (green) • Fair: ≥10% (yellow)
          </p>
        </div>
        <div className="bg-dark-800 rounded-xl px-4 py-2 border border-dark-600 flex-1 flex flex-col justify-between">
          <div>
