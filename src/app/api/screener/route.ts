...
const VALID_PRESETS: Preset[] = ['DEFAULT', 'BREAKOUT', 'EARLY_BREAKOUT', 'OVERSOLD', 'SMART_MONEY', 'VOLUME_CLIMAX', 'SHORT_SQUEEZE', 'MA_TREND', 'TA_ONLY', 'STEALTH_ACCUM', 'BULL_DIV', 'VOL_SPIKE', 'CONSISTENCY'];
const MAX_LIMIT = 50;
